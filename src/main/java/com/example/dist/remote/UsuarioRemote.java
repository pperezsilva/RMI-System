...
public interface UsuarioRemote extends Remote {
    Usuario crear(String token, String username, String password) throws RemoteException;
    ...
    boolean autenticar(String token, String username, String password) throws RemoteException;
    // replicación
